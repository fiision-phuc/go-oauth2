...
//	clients       []oauth.AuthClient
//	users         []oauth.AuthUser
//	accessTokens  []oauth.Token
//	refreshTokens []oauth.Token
//}

//// FindUserWithID returns user with user_id.
//func (s *InMemoryTokenStore) FindUserWithID(userID string) oauth.AuthUser {
...
//func (s *InMemoryTokenStore) FindUserWithClient(clientID string, clientSecret string) oauth.AuthUser {
//	/* Condition validation */
...
//func (s *InMemoryTokenStore) FindUserWithCredential(username string, password string) oauth.AuthUser {
//	/* Condition validation */
...
//func (s *InMemoryTokenStore) FindClientWithID(clientID string) oauth.AuthClient {
//	/* Condition validation */
//	if len(clientID) == 0 {
//		return nil
//	}
...
//func (s *InMemoryTokenStore) FindClientWithCredential(clientID string, clientSecret string) oauth.AuthClient {
//	/* Condition validation */
//	if len(clientID) == 0 || len(clientSecret) == 0 {
//		return nil
//	}
...
//func (s *InMemoryTokenStore) FindAccessToken(token string) oauth.Token {
...
//func (s *InMemoryTokenStore) FindAccessTokenWithCredential(clientID string, userID string) oauth.Token {
//	for _, recordToken := range s.accessTokens {
...
//func (s *InMemoryTokenStore) CreateAccessToken(clientID string, userID string, createdTime time.Time, expiredTime time.Time) oauth.Token {
...
//func (s *InMemoryTokenStore) DeleteAccessToken(token oauth.Token) {
...
//func (s *InMemoryTokenStore) FindRefreshToken(token string) oauth.Token {
...
//func (s *InMemoryTokenStore) FindRefreshTokenWithCredential(clientID string, userID string) oauth.Token {
//	for _, recordToken := range s.refreshTokens {
//		if recordToken.GetUserID() == userID && recordToken.GetClientID() == clientID {
//			return recordToken
//		}
...
//func (s *InMemoryTokenStore) CreateRefreshToken(clientID string, userID string, createdTime time.Time, expiredTime time.Time) oauth.Token {
//	newToken := &TokenDefault{
//		TokenID:     bson.NewObjectId(),
//		UserID:      bson.ObjectIdHex(userID),
//		ClientID:    bson.ObjectIdHex(clientID),
...
//func (s *InMemoryTokenStore) DeleteRefreshToken(token oauth.Token) {
...
//// FindUserWithID returns user with user_id.
//func (m *MongoDBTokenStore) FindUserWithID(userID string) oauth.AuthUser {
//	/* Condition validation */
...
//// FindUserWithClient returns user associated with client_id and client_secret.
//func (m *MongoDBTokenStore) FindUserWithClient(clientID string, clientSecret string) oauth.AuthUser {
//	/* Condition validation */
//	if len(clientID) == 0 || len(clientSecret) == 0 {
//		return nil
//	}
...
//// FindUserWithCredential returns user associated with username and password.
//func (m *MongoDBTokenStore) FindUserWithCredential(username string, password string) oauth.AuthUser {
//	/* Condition validation */
//	if len(username) == 0 || len(password) == 0 {
//		return nil
//	}
...
//// FindClientWithID returns user associated with client_id.
//func (m *MongoDBTokenStore) FindClientWithID(clientID string) oauth.AuthClient {
//	/* Condition validation */
...
//// FindClientWithCredential returns client with client_id and client_secret.
//func (m *MongoDBTokenStore) FindClientWithCredential(clientID string, clientSecret string) oauth.AuthClient {
//	/* Condition validation */
...
//// FindAccessToken returns access_token.
//func (m *MongoDBTokenStore) FindAccessToken(token string) oauth.Token {
//	/* Condition validation */
...
//// FindAccessTokenWithCredential returns access_token associated with client_id and user_id.
//func (m *MongoDBTokenStore) FindAccessTokenWithCredential(clientID string, userID string) oauth.Token {
//	/* Condition validation */
...
//// CreateAccessToken returns new access_token.
//func (m *MongoDBTokenStore) CreateAccessToken(clientID string, userID string, createdTime time.Time, expiredTime time.Time) oauth.Token {
//	/* Condition validation */
//	if len(clientID) == 0 || len(userID) == 0 || !bson.IsObjectIdHex(clientID) || !bson.IsObjectIdHex(userID) {
//		return nil
//	}
...
//// DeleteAccessToken deletes access_token.
//func (m *MongoDBTokenStore) DeleteAccessToken(token oauth.Token) {
//	/* Condition validation */
//	if token == nil {
//		return
//	}
...
//// FindRefreshToken returns refresh_token.
//func (m *MongoDBTokenStore) FindRefreshToken(token string) oauth.Token {
//	/* Condition validation */
//	if len(token) == 0 || !bson.IsObjectIdHex(token) {
//		return nil
//	}
...
//// FindRefreshTokenWithCredential returns refresh_token associated with client_id and user_id.
//func (m *MongoDBTokenStore) FindRefreshTokenWithCredential(clientID string, userID string) oauth.Token {
//	/* Condition validation */
//	if len(clientID) == 0 || len(userID) == 0 || !bson.IsObjectIdHex(clientID) || !bson.IsObjectIdHex(userID) {
//		return nil
//	}
...
//// CreateRefreshToken returns new refresh_token.
//func (m *MongoDBTokenStore) CreateRefreshToken(clientID string, userID string, createdTime time.Time, expiredTime time.Time) oauth.Token {
//	/* Condition validation */
//	if len(clientID) == 0 || len(userID) == 0 || !bson.IsObjectIdHex(clientID) || !bson.IsObjectIdHex(userID) {
//		return nil
//	}
...
//// DeleteRefreshToken deletes refresh_token.
//func (m *MongoDBTokenStore) DeleteRefreshToken(token oauth.Token) {
//	/* Condition validation */
//	if token == nil {
//		return
//	}
